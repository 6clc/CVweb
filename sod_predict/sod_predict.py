...
data_config = DataConfiger.get_data_config('MSRA_B')
...
model_config = ModelConfiger.get_model_config('tiramisu103')
model_config['config']['n_classes'] = 2
...
learner = Learner(model_manager=model_manager,
                          ...
                          metrics=['iou'],
                          scheduler=scheduler,
                          optimizer=optimizer, label=['segment'], task='SOD')
...
sod_predict = inferencer.predict
